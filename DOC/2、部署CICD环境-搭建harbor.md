...
下载解压后进入harbor文件夹执行命令：
```shell
cd harbor && cp harbor.yml.tmpl harbor.yml
```
修改harbor.yml文件中的hostname、port,并注释https相关的配置，如下：
...
```
直接运行 “sudo ./install.sh” 开始离线安装harbor，等待安装完毕。

##### 访问harbor

在浏览器输入http://192.168.211.150:8077

账号: admin

密码: Harbor12345 (默认是Harbor12345，可以在harbor.yml中修改)
<img src="./images/harbor/harbor-01.png" alt="harbor-01.png" style="zoom:50%;" />
<img src="./images/harbor/harbor-02.png" alt="harbor-02.png" style="zoom:50%;" />

登录harbor

<img src="./images/harbor/harbor-03.png" alt="harbor-03.png" style="zoom:50%;" />

创建项目
<img src="./images/harbor/harbor-04.png" alt="harbor-04.png" style="zoom:50%;" />
<img src="./images/harbor/harbor-05.png" alt="harbor-05.png" style="zoom:50%;" />
<img src="./images/harbor/harbor-06.png" alt="harbor-06.png" style="zoom:50%;" />
推送镜像命令
```shell
docker push 192.168.211.150:8077/go-zero-bolog/REPOSITORY[:TAG]
```
配置harbor使用http
使用harbor拉取或者推送镜像默认使用的是http协议，如果不修改/etc/docker/daemon.json配置文件会报“http: server gave HTTP response to HTTPS client”错误
```shell
$ echo '{"insecure-registries":["192.168.211.150:8077"] }' >> /etc/docker/daemon.json
```
harbor安装完成，下一步是安装jenkins
